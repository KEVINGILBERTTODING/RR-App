...
import id.co.rumahraga.databinding.FragmentTransactionDetailBinding;
import id.co.rumahraga.model.ResponseModel;
import id.co.rumahraga.model.TransactionDetailModel;
import id.co.rumahraga.ui.adapters.transactions.TransactionDetailAdapter;
import id.co.rumahraga.ui.fragments.ticket.TicketFragment;
import id.co.rumahraga.util.constans.other.ConsOther;
import id.co.rumahraga.util.constans.sharedpref.ConsSharedPref;
import id.co.rumahraga.viewmodel.transaction.TransactionDetailViewModel;
